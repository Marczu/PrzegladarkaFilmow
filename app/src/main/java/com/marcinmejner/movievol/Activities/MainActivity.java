...
import com.marcinmejner.movievol.Data.MovieRecyclerViewAdapter;
...
import com.marcinmejner.movievol.Util.Prefs;
            ...
            public void onResponse(JSONObject response) {
                ...
                try{
                    ...
                    for (int i = 0; i < moviesArray.length() ; i++) {
                        ...
                        movie.setYear("Rok wydania: " + movieObj.getString("Year"));
                        movie.setMovieType("Gatunek: " + movieObj.getString("Type"));
